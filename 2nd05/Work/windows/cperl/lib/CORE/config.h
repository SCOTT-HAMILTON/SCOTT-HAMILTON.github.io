...
/* Package name      : perl5
 * Source directory  : 
 * Configuration time: Sat Jul  6 10:21:42 2019
 * Configured by     : appveyor
 * Target system     : 
 */
 ...
 */
#define BIN "c:\\cperl\\bin"	/**/
#define BIN_EXP "c:\\cperl\\bin"	/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "c:\\cperl\\site\\lib"		/**/
/*#define SITEARCH_EXP ""	/ **/
 ...
 */
#define SITELIB "c:\\cperl\\site\\lib"		/**/
...
#define PERL_BUILD_DATE "Sat Jul  6 10:21:42 2019"
#endif
 ...
 *      on Windows.
 */
#define PERL_LIBDLL "cperl530.dll"

/* PERL_LIBS:
 *	This defines the names of the shared perl dlls, needed for ffi/DynaLoader limitations
 *      on Windows.
 */
#define PERL_LIBS	"moldname", "kernel32", "user32", "gdi32", "winspool", "comdlg32", "advapi32", "shell32", "ole32", "oleaut32", "netapi32", "uuid", "ws2_32", "mpr", "winmm", "version", "odbc32", "odbccp32", "comctl32", "ffi", 0

/* USE_FFI:
 *	C header equivalent to \undef{useffi}, if -lffi is enabled and linked.
 */
/* HAVE_FFI_*:
